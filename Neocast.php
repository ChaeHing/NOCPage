    ...
    <nav class="navbar navbar-default navbar-fixed-top" role="navigation">
      ...
      <div class="collapse navbar-collapse navbar-ex1-collapse">
        <ul class="nav navbar-nav">
          ...
          <li class="active"><a href="Neocast.php">Neocast</a></li>
...
<?php // 페이지 내용 변경 DEVOPS-151 
    ...
    $sql= "select distinct TITLE from Neocast";   // 패널 중복 생성 방지를 위한 TITLE 중복값을 제거
    ...
    while($row = mysqli_fetch_array($result)){    // 하나의 TITLE당 하나의 패널을 생성
      ...
      $sql2= "select * from Neocast where TITLE = '$title'"; // 현재 TITLE 값만 질의
