<?php
	...
	$menu = $_POST['menu']; // 메뉴
	$type = $_POST['type']; // 변경할 타입 (TITLE, NAME, URL)
	$current = $_POST['current']; // 현재값
	$new = $_POST['new']; // 변경할 값, 새로운 값

    include("dbconnect.php");

    $sql = "update $menu set $type = '$new' where $type = '$current'"; // 변경할 타입에 현재값을 새로운 값으로 변경
